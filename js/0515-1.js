...
console.log(Boolean("")); // 빈문자열 false 
...
// 삼항연산자
// 조건식 ? 실행문1 : 실행문2
// 조건식이 참이면 실팽문1이 실행되고 거짓이면 실행문2가
// 실행된다.
var html="html5";
if(html=="html5") {
...
var num2=20;
// ++ --
console.log(num1++); // 후위, 저장하고 증가
console.log(++num1); // 선위, 증가하고 저장
console.log(--num2);
console.log(num2--);
