...
var 학생3=new Student("정연태",100,93,95,98);
var 학생4=new Student("강호동",90,50,20,50);

// 프로토타입 -> 공통영역에 메소드를 할당 -> 힙(heep)
// 메모리 절약
...
function Circle3(r) {
    ...
    this.setRadius=function(r) {
        ...
        this.print=function() { 
            return `반지름 : ${this.getRadius()} , 원 둘레(정수): ${parseInt(this.getLength())}`
        }
