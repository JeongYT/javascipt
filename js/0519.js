...
// 객체와 배열을 사용한 데이터 관리
// 학생데이터생성
var 학생0={이름:'현빈', 국어:87, 영어:70, 수학:60, 과학:80}
var 학생1={이름:'원빈', 국어:88, 영어:70, 수학:40, 과학:80}
var 학생2={이름:'강호동', 국어:87, 영어:60, 수학:40, 과학:80}
var 학생3={이름:'유재석', 국어:37, 영어:70, 수학:40, 과학:80}
var 학생4={이름:'손흥민', 국어:87, 영어:70, 수학:40, 과학:90}
var 학생5={이름:'김유나', 국어:47, 영어:50, 수학:40, 과학:80}
...
// 배열에 데이터를 추가하기
var students=[];
students.push({이름:'현빈', 국어:87, 영어:70, 수학:60, 과학:80});
students.push(학생1);
students.push(학생2);
students.push(학생3);
students.push(학생4);
...
for(var i in students) {
    ...
    students[i].getAvg=function() {
        // return (this.과학+this.수학+this.국어+this.영어)/4;
        return this.getSum()/4;
    }   
}

document.write(`학생2의 총점 : ${students[2].getSum()}`);
document.write("<br>");
document.write(`학생2의 평균 : ${students[2].getAvg()}`);
...
var 학생들=[];
학생들.push(학생성적표('정연태',90,100,90,95));
학생들.push(학생성적표('안수지',80,75,90,90));
학생들.push(학생성적표('고도희',100,80,95,90));
학생들.push(학생성적표('김윤희',80,70,70,70));
학생들.push(학생성적표('오규한',80,80,90,90));
...
var students=[];
students.push(new Student('정연태',90,100,90,95));
students.push(new Student('안수지',80,75,90,90));
students.push(new Student('고도희',100,80,95,90));
students.push(new Student('김윤희',80,70,70,70));
students.push(new Student('오규한',80,80,90,90));
